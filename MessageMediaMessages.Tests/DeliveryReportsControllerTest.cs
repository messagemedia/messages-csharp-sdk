...
namespace MessageMedia.Messages
{
    ...
    public class DeliveryReportsControllerTest : ControllerTestBase
    {
        ...
        /// </summary>
        private static IDeliveryReportsController controller;
        ...
        {
            controller = GetClient().DeliveryReports;
        }
        ...
        public async Task TestCheckDeliveryReports1() 
        {
            ...
            try
            {
                result = await controller.GetCheckDeliveryReportsAsync();
            }
            catch(APIException) {};
        ...
        public async Task TestConfirmDeliveryReportsAsReceived1() 
        {
            ...
            try
            {
                result = await controller.CreateConfirmDeliveryReportsAsReceivedAsync(body);
            }
            catch(APIException) {};
