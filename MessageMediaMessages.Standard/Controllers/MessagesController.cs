...
namespace MessageMedia.Messages.Controllers
{
    public partial class MessagesController: BaseController
    {
        ...
        public Models.GetMessageStatusResponse GetMessageStatus(string messageId)
        {
            Task<Models.GetMessageStatusResponse> t = GetMessageStatusAsync(messageId);
        ...
        public Models.SendMessagesResponse SendMessages(Models.SendMessagesRequest body)
        {
            Task<Models.SendMessagesResponse> t = SendMessagesAsync(body);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="body">Required parameter: Example: </param>
        /// <return>Returns the Models.SendMessagesResponse response from the API call</return>
        public async Task<Models.SendMessagesResponse> SendMessagesAsync(Models.SendMessagesRequest body)
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
        ...
        public dynamic CancelScheduledMessage(string messageId, Models.CancelScheduledMessageRequest body)
        {
            Task<dynamic> t = CancelScheduledMessageAsync(messageId, body);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic CheckCreditsRemaining()
        {
            Task<dynamic> t = CheckCreditsRemainingAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CheckCreditsRemainingAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.BaseUri;
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/v1/messaging/credits");
