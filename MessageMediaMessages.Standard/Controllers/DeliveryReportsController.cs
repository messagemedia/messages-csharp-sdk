...
{
    public partial class DeliveryReportsController: BaseController
    {
        ...
        {
            Task<Models.CheckDeliveryReportsResponse> t = CheckDeliveryReportsAsync();
        ...
        public dynamic ConfirmDeliveryReportsAsReceived(Models.ConfirmDeliveryReportsAsReceivedRequest body)
        {
            Task<dynamic> t = ConfirmDeliveryReportsAsReceivedAsync(body);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
